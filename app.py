...
def upload_file():
    if request.method == 'POST':
        ...
        # [ {'Company':'Apple Inc.', 'Year':2021, 'LineItem':'Total Revenue', 'Value':81434000000}, 
        #   {'Company':'Apple Inc.', 'Year':2021, 'LineItem':'Net Income',    'Value':21744000000} ]
...
def download_pdf():
    ...
    pdf_bytes = HTML(string=html_out, base_url=request.url_root).write_pdf(outline=False)
